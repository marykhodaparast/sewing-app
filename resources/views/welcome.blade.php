...
<head>
    ...
    @endif
    <style>
        /* Ensures full width and maintains aspect ratio */
        .full-width-image {
            width: 100%;
            height: 600px;
            display: block;
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6">
                    ...
                    <div class="flex-container mt-5">
                        ...
                        <div class="box">
                            <p>
                                <div x-data="{ imageUrl2: '{{ asset("build/assets/images/ketab.jpg") }}' }">

                                    <!-- Image Display -->
                                    <img :src="imageUrl2" alt="Dynamic Image" class="full-width-image">
                                </div>
                            </p>
                        </div>
                    ...
                    <div x-data="{ imageUrl1: '{{ asset("build/assets/images/sewing1.jpg") }}' }" class="mt-5">

                        <!-- Image Display -->
                        <img :src="imageUrl1" alt="Dynamic Image" class="full-width-image">
                    </div>
